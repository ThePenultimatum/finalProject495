...
class PositionControl(object):
    ...
    def __init__(self):
        ...
        self.thetalist = [0.00722578, -1.13799861, -0.01079448, 1.7510739, 0.00573321, 0.95772104, -0.00563395]
        ...
        self.T = np.array([[ 0,  0,  1, self.point.x],
		                   ...
		                   [ 0, -1,  0, self.point.z],
		                   [ 0,  0,  0,            1]])
        self.move_to_position(self.thetalist)


    def move_to_position(self, thetalist0):
        # Solve IK
        ...
        self.waypoints['right_j6'] = self.thetalist[6]
        self.mylimb.move_to_joint_positions(self.waypoints, timeout = 20.0, threshold = 0.05)

        # Publish the current position to perception node
